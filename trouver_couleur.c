...
static THD_FUNCTION(CaptureImage, arg) {
	...
	po8030_advanced_config(FORMAT_RGB565, 0, 10, IMAGE_BUFFER_SIZE, 2, SUBSAMPLING_X1, SUBSAMPLING_X1); // zone considérée
...
static THD_FUNCTION(ProcessImage, arg) {
	...
	while(1){
		...
		for (uint16_t i = 0; i < 2*IMAGE_BUFFER_SIZE; i+=2){ // extrait couleur rouge
			...
			//décalage uniquement de 2 car on multiplie les valeurs par 2 pouetre comparable a celles du vert
		}
